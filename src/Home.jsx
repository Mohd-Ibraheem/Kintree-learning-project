...
function Home() {
  return (
    <>
        ...
        <div className="container">
          <div className="row pt-5">
            <div className="col-12 col-md-6 col-lg-6">
              <div className=' pt-5'>
                <h1 className='fw-bold banner-text text-white'>Build Your Family Tree & Legacy
                  with <span className='k-color'> Kintree</span></h1>
                <p className='main-para text-white'>Connecting Generations, Preserving Legacies</p>
                <p className='text-white fs-5'>The best app for building and maintaining your family tree</p>

                <div className='pt-2'>
                  <button className='me-3 store-btn'><span className='me-2 ' ><FaApple /></span>App Store</button>
                  <button className='ms-3 store-btn play-btn'><span className='me-2'> <FaGooglePlay /></span>Play Store</button>
            ...
            <div className="col-12 col-md-6 col-lg-6">
              <div>
                <video
                  src="/assets/images/Homepage-hero-video.webm"
                  autoPlay
                  loop
                  muted
                  playsInline
        ...
        <div className="container">
          <div className="row">
            <div className='main-img'>
              <img className='mt-5' src="assets\images\new-hero-img.png" alt="" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-12 col-md-5 col-lg-5">
              <h1 className=' fw-bold text-white'>About us <span className="k-color">Kintree</span></h1>
            </div>
            <div className='col-12 col-md-7 col-lg-7'>

              <p className=' fs-6 text-white'>Kintree connects families across generations. Share stories, photos, and memories with loved ones, no matter the distance. We empower you to build stronger bonds and create lasting memories. Family comes first.We believe in making it easy for you to stay in touch with grandparents, cousins, and everyone else who matters to you. Our goal is to help you build stronger family bonds and create lasting memories.</p>
              <Link to="/about">
      ...
      <section className='connection py-5'>
        <div className="container">
          <div className='text-center'>
            <h1 className='fw-bold text-white'><span className='k-color'>Kintree</span> is strengthening family <br />connections</h1>
          </div>
          <div className="row align-items-center">
            <div className='col-12 col-md-12 col-lg-12'>
              <div className='connec-img'>
                <img className='img-fluid ' src="/assets/images/new-connection-img.png" alt="" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className='family-section py-5'>
        <div className="container">
          <div className='text-center'>
            <h1 className='fw-bold'>Tools to Uncover Your Family’s Story</h1>
            <p className=''>Unveiling your family’s history has never been easier. With Kintree’s intuitive family tree maker, you can easily build your family tree, add photos and stories, and connect with relatives near and far. Explore historical records, uncover hidden branches, and preserve your family legacy for generations to come.</p>
          </div>
          <div className="row pt-5">
            <div className='col-12 col-md-3 col-lg-3 mb-4'>
              <Card className='t-card' style={{ width: "100%", height: "200px" }}>
                <Card.Body>
                  <div className='scard-icon mb-3 fs-2'><AiOutlineHome /></div>
                  <h4>Foreroom</h4>
                  <Card.Text>Stay connected with your family on the go and ensure you never miss a moment together.</Card.Text>
                </Card.Body>
              </Card>
            </div>
            <div className='col-12 col-md-4 col-lg-4 mb-4'>
              <Card className='t-card' style={{ width: "100%", height: "200px" }}>
                <Card.Body>
                  <div className='scard-icon fs-2 mb-3'><TbBinaryTreeFilled /></div>
                  <h4> Family tree</h4>
                  <Card.Text>Start by adding your loved ones and see your very own virtual family tree come to life.</Card.Text>
                </Card.Body>
              </Card>
            </div>
            <div className='col-12 col-md-5 col-lg-5 mb-4'>
              <Card className='t-card' style={{ width: "100%", height: "200px" }}>
                <Card.Body>
                  <div className='scard-icon fs-2 mb-3'><PiDna /></div>
                  <h4>DNA</h4>
                  <Card.Text>Unravel your family history with Kintree! Our DNA tests help unlock your ancestry, connect you with relatives worldwide, and reveal your ethnic origins</Card.Text>
                </Card.Body>
              </Card>
            </div>
          </div>
          <div className="row">
            <div className='col-12 col-md-5 col-lg-4 mb-4'>
              <Card className='t-card p-4' style={{ width: "100%", height: "432px" }}>
                <Card.Body>

                  <div className='card-abs-container'>
                    <h4 className='text-center'> Create your Will</h4>
                    <Card.Text className='text-center'>Ensure your loved ones are taken care of even when you’re gone.</Card.Text>
                    <div className='text-center mt-4 tools-img'>
                      <img src="/assets/images/create-will.png.webp" alt="" />
                    </div>
                  </div>
                </Card.Body>
              </Card>
            ...
            <div className='col-12 col-md-7 col-lg-8 mb-4'>
              <Card className='abs-card p-4' style={{ width: "100%", height: "432px" }}>
                <Card.Body>

                  <div className='card-abs-container'>

                    <div className='download-card d-flex justify-content-center align-items-center mt-4'>
                      <div className="download-container">
                        <h2 className='fw-bold pb-3 fs-1'> Download the app and maintain your family tree</h2>
                        <button className='me-3 store-btn play-btn '><span className='me-2'> <FaGooglePlay /></span>Play Store</button>
                        <button className='ms-3 store-btn'><span className='me-2 ' ><FaApple /></span>App Store</button>

                      </div>
                      <div className='tools-img tools-img-2'>
                        <img className='object-fit-cover' src="/assets/images/mobile-kintree.png" alt="" />
                      </div>
                    </div>
                  </div>
                </Card.Body>
          ...
          <div className="row">
            <div className='text-center'>
              ...
              <Nav className="justify-content-center pt-3">
                <Nav.Link as={NavLink} to="/" className="text-white" end>
                  Home
                </Nav.Link>
